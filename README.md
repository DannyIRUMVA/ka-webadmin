...
NUXT_PUBLIC_ADMIN_BASE_URL=https://platform.kakofi.com
...
- `NUXT_PUBLIC_ADMIN_BASE_URL` controls where OAuth should return after Google sign-in. For your setup, this should be `https://platform.kakofi.com`.
- Ensure Supabase Auth allows `https://platform.kakofi.com/auth/callback` in its redirect URL allow-list.
- Do not commit `.env`.
